...
public class DylanDefinitionGenericDefinerImpl extends DylanDefinitionImpl implements DylanDefinitionGenericDefiner {

  public DylanDefinitionGenericDefinerImpl(ASTNode node) {
    super(node);
  }

  @Override
  @Nullable
  public DylanGenericParameterList getGenericParameterList() {
    return findChildByClass(DylanGenericParameterList.class);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DylanVisitor) ((DylanVisitor)visitor).visitDefinitionGenericDefiner(this);
