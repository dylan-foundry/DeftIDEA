...
public class DylanElseStatementImpl extends ASTWrapperPsiElement implements DylanElseStatement {

  public DylanElseStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DylanVisitor) ((DylanVisitor)visitor).visitElseStatement(this);
