...
public class DylanSelectStmtConstituentImpl extends DylanCompositeElementImpl implements DylanSelectStmtConstituent {

  public DylanSelectStmtConstituentImpl(ASTNode node) {
    super(node);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DylanVisitor) ((DylanVisitor)visitor).visitSelectStmtConstituent(this);
