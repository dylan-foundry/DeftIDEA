...
public class DylanDefinitionFunctionDefinerImpl extends DylanNamedElementImpl implements DylanDefinitionFunctionDefiner {

  public DylanDefinitionFunctionDefinerImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DylanFunctionDefinitionTail getFunctionDefinitionTail() {
    return findNotNullChildByClass(DylanFunctionDefinitionTail.class);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DylanVisitor) ((DylanVisitor)visitor).visitDefinitionFunctionDefiner(this);
