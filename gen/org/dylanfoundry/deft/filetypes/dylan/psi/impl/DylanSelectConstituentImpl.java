...
public class DylanSelectConstituentImpl extends ASTWrapperPsiElement implements DylanSelectConstituent {

  public DylanSelectConstituentImpl(ASTNode node) {
    super(node);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DylanVisitor) ((DylanVisitor)visitor).visitSelectConstituent(this);
