...
public class DylanNameImpl extends ASTWrapperPsiElement implements DylanName {

  public DylanNameImpl(ASTNode node) {
    super(node);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DylanVisitor) ((DylanVisitor)visitor).visitName(this);
