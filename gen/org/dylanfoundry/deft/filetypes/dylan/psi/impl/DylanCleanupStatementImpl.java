...
public class DylanCleanupStatementImpl extends ASTWrapperPsiElement implements DylanCleanupStatement {

  public DylanCleanupStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof DylanVisitor) ((DylanVisitor)visitor).visitCleanupStatement(this);
