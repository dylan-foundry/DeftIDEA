...
public class DylanParser implements PsiParser {
  ...
  public ASTNode parse(IElementType root_, PsiBuilder builder_) {
    ...
    else if (root_ == FOR_STATEMENT_TAIL) {
      result_ = for_statement_tail(builder_, level_ + 1);
    }
    ...
    else if (root_ == METHOD_TAIL) {
      result_ = method_tail(builder_, level_ + 1);
    }
    ...
    else if (root_ == SUITE_ARGUMENT) {
      result_ = suite_argument(builder_, level_ + 1);
    }
    else if (root_ == SUITE_ARGUMENT_CLEANUP_FUNCTION) {
      result_ = suite_argument_cleanup_function(builder_, level_ + 1);
    }
    else if (root_ == SUITE_ARGUMENT_DESCRIPTION) {
      result_ = suite_argument_description(builder_, level_ + 1);
    }
    else if (root_ == SUITE_ARGUMENT_SETUP_FUNCTION) {
      result_ = suite_argument_setup_function(builder_, level_ + 1);
    }
    else if (root_ == SUITE_ARGUMENTS) {
      result_ = suite_arguments(builder_, level_ + 1);
    }
    ...
    else if (root_ == SUITE_TEST_TAGS) {
      result_ = suite_test_tags(builder_, level_ + 1);
    }
    ...
    else if (root_ == TEST_ARGUMENT) {
      result_ = test_argument(builder_, level_ + 1);
    }
    else if (root_ == TEST_ARGUMENTS) {
      result_ = test_arguments(builder_, level_ + 1);
    }
    ...
    else if (root_ == UNLESS_TAIL) {
      result_ = unless_tail(builder_, level_ + 1);
    }
    ...
    else if (root_ == UNTIL_TAIL) {
      result_ = until_tail(builder_, level_ + 1);
    }
    ...
    else if (root_ == WHEN_TAIL) {
      result_ = when_tail(builder_, level_ + 1);
    }
    else if (root_ == WHILE_STATEMENT) {
      result_ = while_statement(builder_, level_ + 1);
    }
    else if (root_ == WHILE_TAIL) {
      result_ = while_tail(builder_, level_ + 1);
    }
  ...
  public static boolean binding_pattern(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = binding_pattern_3(builder_, level_ + 1);
    if (!result_) result_ = binding_pattern_4(builder_, level_ + 1);
    if (result_) {
  ...
  private static boolean binding_pattern_1(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && consumeToken(builder_, COLON_COLON);
    result_ = result_ && pattern_variable(builder_, level_ + 1);
    result_ = result_ && consumeTokens(builder_, 0, LESS_THAN, MINUS);
    result_ = result_ && pattern_variable(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // pattern_variable EQUAL pattern_variable
  private static boolean binding_pattern_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "binding_pattern_3")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = pattern_variable(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, EQUAL);
  ...
  // pattern_variable LESS_THAN MINUS pattern_variable
  private static boolean binding_pattern_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "binding_pattern_4")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = pattern_variable(builder_, level_ + 1);
    result_ = result_ && consumeTokens(builder_, 0, LESS_THAN, MINUS);
  ...
  public static boolean body(PsiBuilder builder_, int level_) {
    ...
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_RECOVER_, "<body>");
  ...
  /* ********************************************************** */
  // LBRACE body_style_definition_rule_body RBRACE EQUAL_ARROW rhs
  public static boolean body_style_definition_rule(PsiBuilder builder_, int level_) {
    ...
    enterErrorRecordingSection(builder_, level_, _SECTION_GENERAL_, null);
    result_ = consumeToken(builder_, LBRACE);
    result_ = result_ && body_style_definition_rule_body(builder_, level_ + 1);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, consumeTokens(builder_, -1, RBRACE, EQUAL_ARROW));
    result_ = pinned_ && rhs(builder_, level_ + 1) && result_;
    if (result_ || pinned_) {
  ...
  /* ********************************************************** */
  // DEFINE pattern SEMICOLON? END
  static boolean body_style_definition_rule_body(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "body_style_definition_rule_body")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_RECOVER_, null);
    result_ = consumeToken(builder_, DEFINE);
    result_ = result_ && pattern(builder_, level_ + 1);
    result_ = result_ && body_style_definition_rule_body_2(builder_, level_ + 1);
    ...
    result_ = exitErrorRecordingSection(builder_, level_, result_, false, _SECTION_RECOVER_, null);
    return result_;
  }

  // SEMICOLON?
  private static boolean body_style_definition_rule_body_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "body_style_definition_rule_body_2")) return false;
    consumeToken(builder_, SEMICOLON);
    return true;
  }
  ...
  /* ********************************************************** */
  // !RBRACE
  static boolean body_style_definition_rule_body_recovery(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "body_style_definition_rule_body_recovery")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_NOT_, null);
  ...
  private static boolean definition_macro_call_0(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, DEFINE);
    result_ = result_ && definition_macro_call_body(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // modifiers? define_body_word? body_fragment?
  static boolean definition_macro_call_body(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "definition_macro_call_body")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_RECOVER_, null);
    result_ = definition_macro_call_body_0(builder_, level_ + 1);
    result_ = result_ && definition_macro_call_body_1(builder_, level_ + 1);
    result_ = result_ && definition_macro_call_body_2(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
    ...
    result_ = exitErrorRecordingSection(builder_, level_, result_, false, _SECTION_RECOVER_, definition_macro_call_body_fragment_recovery_parser_);
    return result_;
  }

  // modifiers?
  private static boolean definition_macro_call_body_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "definition_macro_call_body_0")) return false;
    modifiers(builder_, level_ + 1);
    return true;
  }

  // define_body_word?
  private static boolean definition_macro_call_body_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "definition_macro_call_body_1")) return false;
    define_body_word(builder_, level_ + 1);
    return true;
  }

  // body_fragment?
  private static boolean definition_macro_call_body_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "definition_macro_call_body_2")) return false;
  ...
  /* ********************************************************** */
  // !definition_tail
  static boolean definition_macro_call_body_fragment_recovery(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "definition_macro_call_body_fragment_recovery")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_NOT_, null);
    result_ = !definition_tail(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // DEFINE SUITE variable_name LPAREN suite_arguments? RPAREN suite_components? suite_definition_tail
  ...
  // suite_arguments?
  private static boolean definition_suite_definer_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "definition_suite_definer_4")) return false;
    suite_arguments(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // DEFINE TEST variable_name LPAREN test_arguments? RPAREN body? test_definition_tail
  ...
  // test_arguments?
  private static boolean definition_test_definer_4(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "definition_test_definer_4")) return false;
    test_arguments(builder_, level_ + 1);
    return true;
  }

  // body?
  private static boolean definition_test_definer_6(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "definition_test_definer_6")) return false;
    body(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean elseif_statement(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_GENERAL_, null);
    result_ = consumeTokens(builder_, 1, ELSEIF, LPAREN);
    pinned_ = result_; // pin = ELSEIF
    result_ = result_ && report_error_(builder_, expression(builder_, level_ + 1, -1));
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, RPAREN)) && result_;
    result_ = pinned_ && elseif_statement_4(builder_, level_ + 1) && result_;
    if (result_ || pinned_) {
  ...
  public static boolean for_clauses(PsiBuilder builder_, int level_) {
    ...
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_RECOVER_, "<for clauses>");
    ...
    result_ = exitErrorRecordingSection(builder_, level_, result_, false, _SECTION_RECOVER_, for_clauses_recovery_parser_);
    return result_;
  }
  ...
  /* ********************************************************** */
  // !RPAREN
  static boolean for_clauses_recovery(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "for_clauses_recovery")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_NOT_, null);
    result_ = !consumeToken(builder_, RPAREN);
  ...
  /* ********************************************************** */
  // FOR LPAREN for_clauses RPAREN body? finally_clause? for_statement_tail
  public static boolean for_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && for_statement_tail(builder_, level_ + 1);
    if (result_) {
  ...
  /* ********************************************************** */
  // END FOR?
  public static boolean for_statement_tail(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "for_statement_tail")) return false;
    if (!nextTokenIs(builder_, END)) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, END);
    result_ = result_ && for_statement_tail_1(builder_, level_ + 1);
    if (result_) {
      marker_.done(FOR_STATEMENT_TAIL);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  // FOR?
  private static boolean for_statement_tail_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "for_statement_tail_1")) return false;
  ...
  /* ********************************************************** */
  // IF LPAREN statement_test RPAREN body? elseif_statement* else_statement? if_tail
  public static boolean if_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && report_error_(builder_, statement_test(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, RPAREN)) && result_;
    ...
    result_ = pinned_ && report_error_(builder_, if_statement_6(builder_, level_ + 1)) && result_;
    result_ = pinned_ && if_tail(builder_, level_ + 1) && result_;
    if (result_ || pinned_) {
  ...
  /* ********************************************************** */
  // METHOD parameter_list body? method_tail
  public static boolean method_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = pinned_ && method_tail(builder_, level_ + 1) && result_;
    if (result_ || pinned_) {
  ...
  /* ********************************************************** */
  // END METHOD?
  public static boolean method_tail(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_tail")) return false;
    if (!nextTokenIs(builder_, END)) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, END);
    result_ = result_ && method_tail_1(builder_, level_ + 1);
    if (result_) {
      marker_.done(METHOD_TAIL);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  // METHOD?
  private static boolean method_tail_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "method_tail_1")) return false;
    consumeToken(builder_, METHOD);
    return true;
  }
  ...
  /* ********************************************************** */
  // LBRACE rhs_body? RBRACE SEMICOLON?
  ...
  /* ********************************************************** */
  // template
  static boolean rhs_body(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "rhs_body")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_RECOVER_, null);
    result_ = template(builder_, level_ + 1);
    ...
    result_ = exitErrorRecordingSection(builder_, level_, result_, false, _SECTION_RECOVER_, rhs_body_recovery_parser_);
    return result_;
  }

  /* ********************************************************** */
  // !RBRACE
  static boolean rhs_body_recovery(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "rhs_body_recovery")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_NOT_, null);
    result_ = !consumeToken(builder_, RBRACE);
  ...
  /* ********************************************************** */
  // expression
  static boolean statement_test(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "statement_test")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_RECOVER_, null);
    result_ = expression(builder_, level_ + 1, -1);
    ...
    result_ = exitErrorRecordingSection(builder_, level_, result_, false, _SECTION_RECOVER_, statement_test_recovery_parser_);
    return result_;
  }

  /* ********************************************************** */
  // !RPAREN
  static boolean statement_test_recovery(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "statement_test_recovery")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_NOT_, null);
    result_ = !consumeToken(builder_, RPAREN);
  ...
  /* ********************************************************** */
  // suite_argument_description | suite_argument_setup_function | suite_argument_cleanup_function | suite_test_tags
  public static boolean suite_argument(PsiBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // <<keywordWithValue "cleanup-function:">> variable_name
  public static boolean suite_argument_cleanup_function(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suite_argument_cleanup_function")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_GENERAL_, "<suite argument cleanup function>");
    result_ = keywordWithValue(builder_, level_ + 1, "cleanup-function:");
    result_ = result_ && variable_name(builder_, level_ + 1);
    if (result_) {
      marker_.done(SUITE_ARGUMENT_CLEANUP_FUNCTION);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  /* ********************************************************** */
  // <<keywordWithValue "description:">> string
  public static boolean suite_argument_description(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suite_argument_description")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_GENERAL_, "<suite argument description>");
    result_ = keywordWithValue(builder_, level_ + 1, "description:");
    result_ = result_ && string(builder_, level_ + 1);
    if (result_) {
      marker_.done(SUITE_ARGUMENT_DESCRIPTION);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  /* ********************************************************** */
  // <<keywordWithValue "setup-function:">> variable_name
  public static boolean suite_argument_setup_function(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suite_argument_setup_function")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_GENERAL_, "<suite argument setup function>");
    result_ = keywordWithValue(builder_, level_ + 1, "setup-function:");
    result_ = result_ && variable_name(builder_, level_ + 1);
    if (result_) {
      marker_.done(SUITE_ARGUMENT_SETUP_FUNCTION);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  /* ********************************************************** */
  // suite_argument (COMMA suite_argument)*
  public static boolean suite_arguments(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suite_arguments")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_GENERAL_, "<suite arguments>");
    result_ = suite_argument(builder_, level_ + 1);
    result_ = result_ && suite_arguments_1(builder_, level_ + 1);
    if (result_) {
      marker_.done(SUITE_ARGUMENTS);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  // (COMMA suite_argument)*
  private static boolean suite_arguments_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suite_arguments_1")) return false;
    int offset_ = builder_.getCurrentOffset();
    while (true) {
      if (!suite_arguments_1_0(builder_, level_ + 1)) break;
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "suite_arguments_1");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  // COMMA suite_argument
  private static boolean suite_arguments_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suite_arguments_1_0")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && suite_argument(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  /* ********************************************************** */
  // <<keywordWithValue "tags:">> (HASH_BRACKET constants? RBRACKET | <<unreservedNameWithValues "$all">>)
  public static boolean suite_test_tags(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suite_test_tags")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_GENERAL_, "<suite test tags>");
    result_ = keywordWithValue(builder_, level_ + 1, "tags:");
    result_ = result_ && suite_test_tags_1(builder_, level_ + 1);
    if (result_) {
      marker_.done(SUITE_TEST_TAGS);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  // HASH_BRACKET constants? RBRACKET | <<unreservedNameWithValues "$all">>
  private static boolean suite_test_tags_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suite_test_tags_1")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = suite_test_tags_1_0(builder_, level_ + 1);
    if (!result_) result_ = unreservedNameWithValues(builder_, level_ + 1, "$all");
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  // HASH_BRACKET constants? RBRACKET
  private static boolean suite_test_tags_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suite_test_tags_1_0")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, HASH_BRACKET);
    result_ = result_ && suite_test_tags_1_0_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RBRACKET);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // constants?
  private static boolean suite_test_tags_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "suite_test_tags_1_0_1")) return false;
    constants(builder_, level_ + 1);
    return true;
  }
  ...
  public static boolean template_element(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = template_element_16(builder_, level_ + 1);
    if (!result_) result_ = consumeToken(builder_, PARSED_LIST_CONSTANT);
    if (!result_) result_ = consumeToken(builder_, PARSED_VECTOR_CONSTANT);
  ...
  // HASH_BRACKET template? RBRACKET
  private static boolean template_element_16(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "template_element_16")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, HASH_BRACKET);
    result_ = result_ && template_element_16_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RBRACKET);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // template?
  private static boolean template_element_16_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "template_element_16_1")) return false;
    template(builder_, level_ + 1);
    return true;
  }

  /* ********************************************************** */
  // <<keywordWithValue "description:">> string | suite_test_tags
  public static boolean test_argument(PsiBuilder builder_, int level_) {
  ...
  // <<keywordWithValue "description:">> string
  private static boolean test_argument_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "test_argument_0")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = keywordWithValue(builder_, level_ + 1, "description:");
    result_ = result_ && string(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // test_argument (COMMA test_argument)*
  public static boolean test_arguments(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "test_arguments")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_GENERAL_, "<test arguments>");
    result_ = test_argument(builder_, level_ + 1);
    result_ = result_ && test_arguments_1(builder_, level_ + 1);
    if (result_) {
      marker_.done(TEST_ARGUMENTS);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  // (COMMA test_argument)*
  private static boolean test_arguments_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "test_arguments_1")) return false;
    int offset_ = builder_.getCurrentOffset();
    while (true) {
      if (!test_arguments_1_0(builder_, level_ + 1)) break;
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "test_arguments_1");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  // COMMA test_argument
  private static boolean test_arguments_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "test_arguments_1_0")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, COMMA);
    result_ = result_ && test_argument(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  /* ********************************************************** */
  // UNLESS LPAREN statement_test RPAREN body? unless_tail
  public static boolean unless_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && statement_test(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, RPAREN);
    result_ = result_ && unless_statement_4(builder_, level_ + 1);
    result_ = result_ && unless_tail(builder_, level_ + 1);
    if (result_) {
  ...
  /* ********************************************************** */
  // END UNLESS?
  public static boolean unless_tail(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "unless_tail")) return false;
    if (!nextTokenIs(builder_, END)) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, END);
    result_ = result_ && unless_tail_1(builder_, level_ + 1);
    if (result_) {
      marker_.done(UNLESS_TAIL);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  // UNLESS?
  private static boolean unless_tail_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "unless_tail_1")) return false;
  ...
  /* ********************************************************** */
  // UNTIL LPAREN statement_test RPAREN body? until_tail
  public static boolean until_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && until_tail(builder_, level_ + 1);
    if (result_) {
  ...
  /* ********************************************************** */
  // END UNTIL?
  public static boolean until_tail(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "until_tail")) return false;
    if (!nextTokenIs(builder_, END)) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, END);
    result_ = result_ && until_tail_1(builder_, level_ + 1);
    if (result_) {
      marker_.done(UNTIL_TAIL);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  // UNTIL?
  private static boolean until_tail_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "until_tail_1")) return false;
  ...
  /* ********************************************************** */
  // WHEN LPAREN statement_test RPAREN body? when_tail
  public static boolean when_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && when_tail(builder_, level_ + 1);
    if (result_) {
  ...
  /* ********************************************************** */
  // END WHEN?
  public static boolean when_tail(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "when_tail")) return false;
    if (!nextTokenIs(builder_, END)) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, END);
    result_ = result_ && when_tail_1(builder_, level_ + 1);
    if (result_) {
      marker_.done(WHEN_TAIL);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  // WHEN?
  private static boolean when_tail_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "when_tail_1")) return false;
    consumeToken(builder_, WHEN);
    return true;
  }

  /* ********************************************************** */
  // WHILE LPAREN statement_test RPAREN body? while_tail
  public static boolean while_statement(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && while_tail(builder_, level_ + 1);
    if (result_) {
  ...
  /* ********************************************************** */
  // END WHILE?
  public static boolean while_tail(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "while_tail")) return false;
    if (!nextTokenIs(builder_, END)) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, END);
    result_ = result_ && while_tail_1(builder_, level_ + 1);
    if (result_) {
      marker_.done(WHILE_TAIL);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  // WHILE?
  private static boolean while_tail_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "while_tail_1")) return false;
  ...
  final static Parser definition_macro_call_body_fragment_recovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return definition_macro_call_body_fragment_recovery(builder_, level_ + 1);
    }
  };
  final static Parser for_clauses_recovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return for_clauses_recovery(builder_, level_ + 1);
    }
  };
  final static Parser rhs_body_recovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return rhs_body_recovery(builder_, level_ + 1);
    }
  };
  ...
  final static Parser statement_test_recovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
